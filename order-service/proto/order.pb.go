...
type OrderItem struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Item          *proto.CartItem        `protobuf:"bytes,1,opt,name=item,proto3" json:"item,omitempty"`
...
func (x *OrderItem) GetItem() *proto.CartItem {
	if x != nil {
		return x.Item
	}
	return nil
...
var file_order_proto_rawDesc = string([]byte{
	...
	0x42, 0x15, 0x5a, 0x13, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_order_proto_goTypes = []any{
	...
	(*proto.CartItem)(nil),    // 10: cart.CartItem
}
